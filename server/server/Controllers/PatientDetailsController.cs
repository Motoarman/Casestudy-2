...
namespace server.Controllers
{
    public class PatientDetailsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,PhoneNo,EmailId,Age,Gender,MedicalComplaint,SelectedDate,SelectedSlot,VisitingStatus")] PatientDetail patientDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,PhoneNo,EmailId,Age,Gender,MedicalComplaint,SelectedDate,SelectedSlot,VisitingStatus")] PatientDetail patientDetail)
        {
